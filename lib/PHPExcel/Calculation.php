...
class PHPExcel_Calculation
{
    ...
    /**
     * The debug log.txt generated by the calculation engine
     *
     * @access    private
    ...
    /**
     * An array of the nested cell references accessed by the calculation engine, used for the debug log.txt
     *
     * @access    private
     * @var array of string
     *
     ...
     * @access    public
     * @param    PHPExcel_Cell    $pCell        Cell to calculate
     * @param    Boolean            $resetLog    Flag indicating whether the debug log.txt should be reset or not
     * @return    mixed
     * @throws    PHPExcel_Calculation_Exception
     */
    ...
    /**
     * Format details of an operand for display in the log.txt (based on operand type)
     *
    ...
    /**
     * Format type and details of an operand for display in the log.txt (based on operand type)
     *
     * @param    mixed        $value    First matrix operand
     * @return    mixed
     */
...
//        }
     ...
     * @param    boolean                $resetLog    Flag indicating whether calculation log.txt should be reset or not
